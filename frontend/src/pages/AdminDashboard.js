...
export default AdminDashboard;
      ...
      <Dialog open={showTelegramDialog} onOpenChange={setShowTelegramDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Telegram Ayarlari</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleUpdateTelegram} className="space-y-4">
            <div>
              ...
              <Input
                ...
                required
              />
              <p className="text-xs text-gray-500 mt-1">@BotFather'dan alin</p>
            </div>
            <div>
              <Label>Chat ID</Label>
              <Input
                ...
                required
              />
              <p className="text-xs text-gray-500 mt-1">Grup veya kullanici chat ID</p>
            </div>
            <div className="bg-blue-50 p-3 rounded">
              <p className="text-xs text-blue-800">
                <strong>Not:</strong> Kaydet'e bastiginda test mesaji gonderilecek. Mesaj gelirse baglanti basarili!
              </p>
            </div>
            <Button type="submit" className="w-full">Kaydet ve Test Et</Button>
          </form>
        </DialogContent>
      </Dialog>
